                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="buy-medicine.php">Buy Medicine</a>
                                    <a class="nav-link" href="list-medicines.php">View Medicine</a>
                            ...
                            <div class="collapse" id="collapsePosts" aria-labelledby="Orders" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="my-order.php">My Orders</a>
                                    <a class="nav-link" href="cancelled-order.php">Cancelled Orders</a>
                                </nav>
                            </div>
