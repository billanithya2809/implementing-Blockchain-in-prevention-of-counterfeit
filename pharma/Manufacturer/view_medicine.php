                                    ...
                                    { $i=1;
                                        ...
                                        { ?>
                                            <tr>
                                                ...
                                                <td><a href="edit_medicine.php?id=<?=$item['id']?>" class="btn btn-sm btn-warning" type="submit">Edit</a></td>
                                                <td>
                                                    <form action="code.php" method="post">
                                                        <input type="hidden" name="user_id" value="<?=$item['id'];?>">
                                                        <button class="btn btn-sm btn-danger" name="medicine_delete" type="submit">Delete</button>
                                                    </form>
                                                </td>
                                            </tr> <?php
                                        }
